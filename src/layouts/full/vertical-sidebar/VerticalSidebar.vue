...
<template>
  <v-navigation-drawer left v-model="drawer.Sidebar_drawer" elevation="0" mobile-breakpoint="lg" app
    class="leftSidebar">
    ...
    <div class="px-6 pt-3 pb-3">
      <v-menu v-model="menuOpen" :close-on-content-click="false" location="end">
        <template v-slot:activator="{ props }">
          <v-btn color="primary" variant="elevated" block rounded="sm" class="text-none" v-bind="props">
        ...
        <v-sheet rounded="md" elevation="12" class="ml-2">
          <NewDD @close="closeMenu" @open-category-modal="openCategoryModal" @open-upload-modal="openUploadModal" />
        </v-sheet>
      </v-menu>
    </div>
