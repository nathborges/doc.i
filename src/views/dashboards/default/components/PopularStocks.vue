    ...
    <v-card variant="outlined">
      <v-card-text>
        <div class="d-flex align-center">
          <h4 class="text-h4 mt-1">Ações Populares</h4>
          <div class="ml-auto">
            <v-menu transition="slide-y-transition">
              ...
              <v-sheet rounded="md" width="150" class="elevation-10">
                <v-list>
                  ...
                  <v-list-item value="2">
                    <v-list-item-title>Este Mês</v-list-item-title>
                  </v-list-item>
                  <v-list-item value="3">
                    <v-list-item-title>Este Ano</v-list-item-title>
                  </v-list-item>
                </v-list>
              </v-sheet>
            </v-menu>
          ...
          <div class="pa-5">
            <div class="d-flex align-start justify-space-between">
              <div>
                ...
                <span class="text-subtitle-2 text-medium-emphasis font-weight-bold">10% Lucro</span>
              </div>
