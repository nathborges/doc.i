  ...
  <v-card elevation="0" class="bg-primary overflow-hidden bubble-shape-sm bubble-primary mb-6">
    <v-card-text class="pa-5">
      <div class="d-flex align-center ga-4">
        ...
        <div>
          <h4 class="text-h4 font-weight-medium">Contratos</h4>
          <span class="text-subtitle-2 text-medium-emphasis text-white">Teste</span>
        </div>
      </div>
    </v-card-text>
  </v-card>
    ...
    <v-card-text class="pa-5">
      <div class="d-flex align-center ga-4">
        ...
        <div>
          ...
          <span class="text-subtitle-2 text-disabled font-weight-medium">Receita Total</span>
        </div>
      </div>
    </v-card-text>
  </v-card> -->
