<template>
  <div class="header">
    <div class="header-title">
      ...
      <div v-if="pageTitle" class="category-icon" :style="{ color: categoryStore.selectedCategoryColor }">
        <span class="material-icons">label</span>
      </div>
      <h1 v-if="pageTitle" class="page-title">{{ pageTitle }}</h1>
      <div class="user-profile">
        <div class="upload-button">
          <BaseButton text="Importar" icon="upload" variant="primary" size="small" @click="openUploadModal" />
        </div>
