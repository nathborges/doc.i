  ...
  <div class="files-table">
    ...
    <div class="table-body">
      <div class="table-row" v-for="file in files" :key="file.id">
        <div class="col-name">
          <span class="material-icons file-type-icon">{{ getFileIcon(file.fileName || file.name) }}</span>
        ...
        <div class="col-modified">{{ formatDate(file.createdAt || file.modified) }}</div>
        <div class="col-size">{{ formatFileSize(file.fileSize || file.size) }}</div>
        <div class="col-actions" v-if="showActions">
          <button @click="$emit('open-file', file)" class="action-btn">
            <span class="material-icons">download</span>
          </button>
          <button @click="$emit('delete-file', file.id)" class="action-btn delete">
